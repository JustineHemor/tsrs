...
<h1 style="margin-top: 25px; margin-bottom: -20px;">Trip Ticket Cancelled: {{ $tripTicket->id }}</h1>
<x-mail::table>
|               |              |
| ------------- |:-------------|
...
|<b style="white-space: nowrap; padding-right: 10px;">Remarks:</b> | {{ $tripTicket->remarks }} |
</x-mail::table>
